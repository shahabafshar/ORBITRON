...
#    ["saturator"]="node1-2.outdoor.orbit-lab.org|10.1.0.16|saturator|wlan0|saturation_network"
    ["saturator"]="node1-2.outdoor.orbit-lab.org|10.1.0.16|client|wlan0|main_network"
    ["jammer"]="node1-4.outdoor.orbit-lab.org|10.1.0.18|jammer|wlan0|"
#    ["control"]="node1-9.outdoor.orbit-lab.org|10.1.0.19|control|wlan0|"
    ["control"]="node1-9.outdoor.orbit-lab.org|10.1.0.19|client|wlan0|main_network"
)
...
declare -A NETWORKS=(
    ...
    ["saturation_network"]="orbit_saturation|orbit1234|6|g|1|2|WPA-PSK|TKIP|CCMP"
)
